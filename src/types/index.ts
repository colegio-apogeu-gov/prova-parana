...
export const UNIDADE_MAPEADA: Record<(typeof UNIDADES_ESCOLARES)[number], string> = {
  ...
  'CARNEIRO C E GAL EF M PROFIS': 'CARNEIRO C E GAL EF M PROFIS',
  ...
  'GILDO A SCHUCK C E PROF EF M ETI N': 'GILDO A SCHUCK C E PROF EF M ETI N',
  'GODOFREDO MACHADO, E E-EF': 'GODOFREDO MACHADO E E EF',
  'HOMERO B DE BARROS C E EFM ETI': 'HOMERO B DE BARROS C E EFM ETI',
  ...
  'VICTOR DO AMARAL C E PROF EFM ETI PROFI': 'VICTOR DO AMARAL C E PROF EFM ETI PROFI'
};
