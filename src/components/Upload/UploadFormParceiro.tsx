...
const UploadFormParceiro: React.FC<UploadFormParceiroProps> = ({ userProfile }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const fileInput = document.getElementById('file-upload-parceiro') as HTMLInputElement;
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`px-3 py-1.5 text-sm rounded-lg font-medium transition-colors ${!bulkMode ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
          >
            Individual
          </button>
          <button
      ...
      {!bulkMode ? (
          ...
          <div className="grid md:grid-cols-5 gap-4">
            ...
            <div>
              ...
              >
                ...
                <option value="8º ano">8o ano</option>
                <option value="7º ano">7o ano</option>
                <option value="6º ano">6o ano</option>
                <option value="3º ano">3o ano</option>
                <option value="2º ano">2o ano</option>
                <option value="1º ano">1o ano</option>
              </select>
            </div>
                ...
                <table className="min-w-full text-xs">
                  <thead>
                    <tr className="bg-gray-100">
                      ...
                      <th className="px-2 py-1 text-left">Proficiencia</th>
                      <th className="px-2 py-1 text-left">Padrao</th>
        ...
        <div className="space-y-6">
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <h4 className="text-sm font-semibold text-green-900 mb-1">Formato do nome do arquivo</h4>
            <p className="text-sm text-green-800">
              NOMEDAESCOLA_ANOPROVA_SEMESTRE_ANOESCOLAR_COMPONENTE
            </p>
            <p className="text-xs text-green-700 mt-1">
              Exemplo: ANITACANET_2025_1_8ANO_LP.xlsx | PAULOFREIRE_2025_2_7ANO_MT.csv
            </p>
          </div>
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-green-400 transition-colors">
              ...
              />
              <label
                htmlFor="file-upload-bulk-parceiro"
                className="bg-green-50 text-green-600 px-4 py-2 rounded-lg cursor-pointer hover:bg-green-100 transition-colors"
              >
                Selecionar Arquivos
              </label>
          ...
          {bulkProgress && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-green-900">Processando...</span>
                <span className="text-sm text-green-700">{bulkProgress.current} / {bulkProgress.total}</span>
              </div>
